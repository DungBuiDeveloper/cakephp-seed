...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/lost-password-step-one',['controller' => 'account','action' => 'lostPassword']);
    $routes->connect('/lost-password-step-two',['controller' => 'account','action' => 'lostPasswordStepTwo']);
